...
<body onload="window.print()">
    ...
    <table border cellpadding="3" align="center" width="90%" style="border-collapse: collapse;">
        ...
        foreach ($data as $user) {
            $no++;
            if ($user->hasil_seleksi == '1') {
                $lulus = $lulus + 1;
            } elseif ($user->hasil_seleksi == '2') {
                $cadangan = $cadangan + 1;
            } else {
                $gagal = $gagal + 1;
            }
    ...
    <table border="0" cellpadding="3" align="center" width="90%" style="border-collapse: collapse;">
        ...
        <tr>
            <td>Jumlan Lusus <?php echo $lulus; ?></td>
        </tr>
        <tr>
            <td>Jumlan Cadangan <?php echo $cadangan; ?></td>
        </tr>
        <tr>
            <td>Jumlan Gagal <?php echo $gagal; ?></td>
        </tr>
    </table>
    <br>
