...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Data Penanganan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="">Home</a></li>
            <li class="breadcrumb-item active">Data Penanganan</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  ...
  function save() {
    ...
    if (id_penyakit.trim() == '' && save_mothod == 'add') {
      ...
      var url;
      if (save_mothod == 'add') {
        url = '<?php echo base_url('admin_solusi/simpan'); ?>';
      } else {
        url = '<?php echo base_url('admin_solusi/simpanedit'); ?>';
      }
  ...
  function simpan_hapus() {
    ...
    if (password.trim() == '') {
      ...
      var url = '<?php echo base_url('admin_solusi/hapus'); ?>';
      $.ajax({
        url: url,
        type: 'POST',
  ...
  function edit(id) {
    ...
    $('#id_form')[0].reset();
    $.ajax({
      url: "<?php echo base_url('admin_solusi/edit/'); ?>" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        $('[name="kode"]').val(data.id_solusi);
  ...
  function download() {
    window.location.href = "<?php echo base_url('admin_solusi/download/') ?>";
  }
  ...
  function cetak_print() {
    ...
    window.open('<?php echo base_url() ?>admin_solusi/cetak?jabatan=' + jabatan + '&nama=' + nama, '_blank');
  }
</script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal_title" id="exampleModalLabel">Input Penanganan</h5>
      </div>
        ...
        <form id="id_form">
          <div class="form-group">
            ...
            <select class="form-control" id="id_penyakit" name="id_penyakit">
              ...
              <?php
              foreach ($penyakit as $user) {
              ?>
                <option value="<?php echo $user->id_penyakit; ?>"><?php echo $user->nama_penyakit; ?></option>
              <?php } ?>
            </select>
